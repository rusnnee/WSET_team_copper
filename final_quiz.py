...
def quiz(y):
    ...
    Button(frame1, text="Blotting the wound dry",font=("Arial",10), bg="black", command=a1_wrong).grid(row=3, column=1)
    Button(frame1, text="Putting gloves on for protection",font=("Arial",10), bg="black", command=a1_right).grid(row=3, column=2)
    Button(frame1, text="Desinfecting the wound",font=("Arial",10), bg="black",command=a1_wrong).grid(row=3, column=3)

    Label(frame2, text="F.A.S.T stands for...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame2, text="Funny Appearance Sound Tone",font=("Arial",10), bg="black",command=a2_wrong).grid(row=3, column=1)
    Button(frame2, text="Face Arms Speach Time",font=("Arial",10), bg="black",command=a2_right).grid(row=3, column=2)
    Button(frame2, text="Feet Abdomen Stomach Tongue",font=("Arial",10), bg="black",command=a2_wrong).grid(row=3, column=3)

    Label(frame3, text="If the subject is bleading from an injury, you should desindect with...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame3, text="Hydrogen peroxyde",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=1)
    Button(frame3, text="Soap and water",font=("Arial",10), bg="black",command=a3_right).grid(row=3, column=2)
    Button(frame3, text="Isopropyl alcohol",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=3)
    ...
    Button(frame4, text="Are you okay?",font=("Arial",10), bg="black",command=a4_wrong).grid(row=3, column=1)
    Button(frame4, text="Do you have an epinephrine autoinjector?",font=("Arial",10), bg="black",command=a4_right).grid(row=3, column=2)
    Button(frame4, text="Can you walk?",font=("Arial",10), bg="black",command=a4_wrong).grid(row=3, column=3)

    Label(frame5, text="The Heimlich maneuvre consists of...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame5, text="6 to 10 abdominal thrusts",font=("Arial",10), bg="black",command=a5_right).grid(row=3, column=1)
    Button(frame5, text="6 to 10 chest thrusts",font=("Arial",10), bg="black",command=a5_wrong).grid(row=3, column=2)
    Button(frame5, text="1 to 3 abdomical thrusts",font=("Arial",10), bg="black",command=a5_wrong).grid(row=3, column=3)
    
    Label(frame6, text="Click on all the symptoms of a stroke:", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame6, text="Sudden blurry vision",font=("Arial",10), bg="black", command=a6_right).grid(row=3, column=1)
    Button(frame6, text="Numbness, especially on one member",font=("Arial",10), bg="black", command=a6_right).grid(row=3, column=2)
    Button(frame6, text="Sudden confusion or trouble speaking clearly",font=("Arial",10), bg="black",command=a6_right).grid(row=3, column=3)

    Label(frame7, text="Click on all the symptoms of a strong allergic reaction:", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame7, text="Skin reactions (itching, hives...)",font=("Arial",10), bg="black", command=a7_right).grid(row=3, column=1)
    Button(frame7, text="Swelling of the eyes, face or throat",font=("Arial",10), bg="black", command=a7_right).grid(row=3, column=2)
    Button(frame7, text="nausea or diarrhea",font=("Arial",10), bg="black",command=a7_right).grid(row=3, column=3)

    Label(frame8, text="If an infant younger than age 1 is choking...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame8, text="Hold the infant in seating position facedown",font=("Arial",10), bg="black",command=a8_right).grid(row=3, column=1)
    Button(frame8, text="Perform CPR if the infant still doesn't breathe",font=("Arial",10), bg="black",command=a8_right).grid(row=3, column=2)
    Button(frame8, text="Call for emergency medical help",font=("Arial",10), bg="black",command=a8_right).grid(row=3, column=3)

    Label(frame9, text="If the subject had an electrical burn", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame9, text="Call emergency medical help",font=("Arial",10), bg="black",command=a9_right).grid(row=3, column=1)
    Button(frame9, text="Wait to see if they are feeling pain",font=("Arial",10), bg="black",command=a9_wrong).grid(row=3, column=2)
    Button(frame9, text="Help the subject sit down no matter how high the voltage source",font=("Arial",10), bg="black",command=a9_wrong).grid(row=3, column=3)

    Label(frame10, text="Immediately call an ambulance if the subject of the burn...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame10, text="Is going into shock (sweating, shallow breathing, cold and clammy skin...)",font=("Arial",10), bg="black",command=a10_right).grid(row=3, column=1)
    Button(frame10, text="If over 60 or under 5",font=("Arial",10), bg="black",command=a10_right).grid(row=3, column=2)
    Button(frame10, text="Has a medical condition/weakened immune system",font=("Arial",10), bg="black",command=a10_right).grid(row=3, column=3)
