...
def quiz(y):
    ...
    Button(frame1, text="Difficulty or noisy breathing",font=("Arial",10), bg="black", command=a1_right).grid(row=3, column=1)
    Button(frame1, text="Cough (either weak or forceful)",font=("Arial",10), bg="black", command=a1_right).grid(row=3, column=2)
    Button(frame1, text="Skin, lips and nails turning blue or dusky",font=("Arial",10), bg="black",command=a1_right).grid(row=3, column=3)

    Label(frame2, text="The Heimlich maneuvre consists of...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame2, text="6 to 10 abdominal thrusts",font=("Arial",10), bg="black",command=a2_right).grid(row=3, column=1)
    Button(frame2, text="6 to 10 chest thrusts",font=("Arial",10), bg="black",command=a2_wrong).grid(row=3, column=2)
    Button(frame2, text="1 to 3 abdomical thrusts",font=("Arial",10), bg="black",command=a2_wrong).grid(row=3, column=3)

    Label(frame3, text="The 5-and-5 approach is delivered", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame3, text="If the subject can't breathe/talk forcefully",font=("Arial",10), bg="black",command=a3_right).grid(row=3, column=1)
    Button(frame3, text="Whenever someone seems like they are choking",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=2)
    Button(frame3, text="After the subject faints",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=3)

    Label(frame4, text="If the subject is unconscious", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame4, text="Try mouth to mouth",font=("Arial",10), bg="black",command=a4_wrong).grid(row=3, column=1)
    Button(frame4, text="Try a finger sweep even if you can't see the object",font=("Arial",10), bg="black",command=a4_wrong).grid(row=3, column=2)
    Button(frame4, text="Lower the subject and perform the Heimlich maneuvre",font=("Arial",10), bg="black",command=a4_right).grid(row=3, column=3)

    Label(frame5, text="If the subject is an infant younger than age 1", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame5, text="Hold the infant in seating position facedown",font=("Arial",10), bg="black",command=a5_right).grid(row=3, column=1)
    Button(frame5, text="Perform CPR if the infant still doesn't breathe",font=("Arial",10), bg="black",command=a5_right).grid(row=3, column=2)
    Button(frame5, text="Call for emergency medical help",font=("Arial",10), bg="black",command=a5_right).grid(row=3, column=3)
