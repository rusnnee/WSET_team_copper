...
def quiz(y):
    ...
    Button(frame1, text="Sudden blurry vision",font=("Arial",10), bg="black", command=a1_right).grid(row=3, column=1)
    Button(frame1, text="Numbness, especially on one member",font=("Arial",10), bg="black", command=a1_right).grid(row=3, column=2)
    Button(frame1, text="Sudden confusion or trouble speaking clearly",font=("Arial",10), bg="black",command=a1_right).grid(row=3, column=3)
    ...
    Button(frame3, text="To call an ambulance",font=("Arial",10), bg="black",command=a3_right).grid(row=3, column=1)
    Button(frame3, text="To perform CPR",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=2)
    Button(frame3, text="To bring water to the subject",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=3)

    Label(frame4, text="Click on everything you should NOT do:", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame4, text="Feed the subject",font=("Arial",10), bg="black",command=a4_right).grid(row=3, column=1)
    Button(frame4, text="Let the subject fall asleep",font=("Arial",10), bg="black",command=a4_right).grid(row=3, column=2)
    Button(frame4, text="Give the subject medication",font=("Arial",10), bg="black",command=a4_right).grid(row=3, column=3)

    Label(frame5, text="If the symptoms vanish after a few minutes...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame5, text="The subject is safe",font=("Arial",10), bg="black",command=a5_wrong).grid(row=3, column=1)
    Button(frame5, text="The subject should take some rest",font=("Arial",10), bg="black",command=a5_wrong).grid(row=3, column=2)
    Button(frame5, text="Still call for medical help",font=("Arial",10), bg="black",command=a5_right).grid(row=3, column=3)
