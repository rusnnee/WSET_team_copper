...
def quiz(y):
    ...
    Button(frame2, text="Hydrogen peroxyde",font=("Arial",10), bg="black",command=a2_wrong).grid(row=3, column=1)
    Button(frame2, text="Soap and water",font=("Arial",10), bg="black",command=a2_right).grid(row=3, column=2)
    Button(frame2, text="Isopropyl alcohol",font=("Arial",10), bg="black",command=a2_wrong).grid(row=3, column=3)

    Label(frame3, text="Applying ice packs is useful for...", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame3, text="Pain relief",font=("Arial",10), bg="black",command=a3_right).grid(row=3, column=1)
    Button(frame3, text="Stopping the bleeding",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=2)
    Button(frame3, text="Calming the subject",font=("Arial",10), bg="black",command=a3_wrong).grid(row=3, column=3)
    ...
    Button(frame4, text="Simply wait for an ambulance",font=("Arial",10), bg="black",command=a4_wrong).grid(row=3, column=1)
    Button(frame4, text="Use the cloth even if dirty",font=("Arial",10), bg="black",command=a4_wrong).grid(row=3, column=2)
    Button(frame4, text="Apply pressure with your hands to stop the bleeding",font=("Arial",10), bg="black",command=a4_right).grid(row=3, column=3)

    Label(frame5, text="If the subject has a chest injury and is unconscious", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame5, text="Lay them down on their back",font=("Arial",10), bg="black",command=a5_wrong).grid(row=3, column=1)
    Button(frame5, text="Put them in sitting position",font=("Arial",10), bg="black",command=a5_wrong).grid(row=3, column=2)
    Button(frame5, text="Place them carefully on their side",font=("Arial",10), bg="black",command=a5_right).grid(row=3, column=3)
