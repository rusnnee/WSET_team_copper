...
# Button function
def info():
    subprocess.call(['python', 'Info_choking.py'])

def multi():
    subprocess.call(['python', 'choking_quiz.py'])

def dropdown():
    subprocess.call(['python', 'fonts.py'])

def exit_program(*args):
    window.destroy()

#Title label
title = Label( window , text = "Choking", bg = "black", fg = 'white' )
