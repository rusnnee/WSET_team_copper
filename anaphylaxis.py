...
def quiz(y):
    ...
    Button(frame1, text="Skin reactions (itching, hives...)",font=("Arial",10), command=a1_right).grid(row=3, column=1)
    Button(frame1, text="Swelling of the eyes, face or throat",font=("Arial",10), command=a1_right).grid(row=3, column=2)
    Button(frame1, text="nausea or diarrhea",font=("Arial",10), command=a1_right).grid(row=3, column=3)

    Label(frame2, text="What can be a cause of anaphylactic shock?", font=("Arial", 20)).grid(row=2, column=2)
    Button(frame2, text="Emotional shock",font=("Arial",10), command=a2_wrong).grid(row=3, column=1)
    Button(frame2, text="Allergen foods",font=("Arial",10), command=a2_right).grid(row=3, column=2)
    Button(frame2, text="High physical activity",font=("Arial",10),command=a2_wrong).grid(row=3, column=3)
    ...
    Button(frame3, text="Are you okay?",font=("Arial",10), command=a3_wrong).grid(row=3, column=1)
    Button(frame3, text="Do you have an epinephrine autoinjector?",font=("Arial",10), command=a3_right).grid(row=3, column=2)
    Button(frame3, text="Can you walk?",font=("Arial",10), command=a3_wrong).grid(row=3, column=3)
